  ...
  const filteredInventory = useMemo(() => {
    return inventory.filter(item => {
      ...
      const matKeywords = [
        ...
        // Itens que disparavam falso-positivo de medicamento
        "MARCACAO",    // CANETA MARCACAO CIR → material (CANETA batia no regex de injetável)
        "OSTOMIA",     // BOLSA COLOSTOMIA / ILEOSTOMIA / UROSTOMIA (BOLSA batia no regex de injetável)
        "HME",         // FILTRO HME BACT/VIRAL (100ML batia no keyword ML de medicamento)
        "EQUIPAMENTO", // CAPA EQUIPAMENTO VIDEOCIRURGIA (EQUIPAMENTO contém "UI" que batia no keyword)
        "VIDEOCIRURG", // reforço para coberturas / capas de videocirurgia
        "BISTURI", "LAMINA", "SWAB", "LANCETA", "ABAIXADOR",
        "ATADURA", "MICROPORE", "PULSEIRA", "BRACADEIRA", "TERMOMETRO",
        "CANULA", "ESCALPE", "ESPATULA", "ADAPTADOR", "TORNEIRA", "CONECTOR",
        "PROPE", "ABSORVENTE", "TALA", "CUPULA", "PINCA", "TESOURA",
        "BOLSA COLET", "BOLSA URIN", "BOLSA DREN"
      ];
